...
public class Program
{
    static void Main(string[] args)
    {
        ...
        DirectoryInfo anshulsDir = new DirectoryInfo(@"C:\Users\Anshul.g");

        // Get the directory path
        Console.WriteLine(anshulsDir.FullName);

        // Get the directory name
        Console.WriteLine(anshulsDir.Name);

        // Get the parent directory5
        Console.WriteLine(anshulsDir.Parent);

        // What type is it
        Console.WriteLine(anshulsDir.Attributes);

        // When was it created
        Console.WriteLine(anshulsDir.CreationTime);

        // Create a directory
        DirectoryInfo dataDir = new DirectoryInfo(@"C:\Users\anshulCsharp\C#Data");
        dataDir.Create();
        ...
        string textFilePath = @"C:\Users\anshulCsharp\C#Data\testfile1.txt";
        ;
        // Write the array
        ...
        DirectoryInfo myDataDir = new DirectoryInfo(@"C:\Users\anshulCsharp\C#Data");
        ...
        string textFilePath2 = @"C:\Users\anshulCsharp\C#Data\testfile2.txt";
        ...
        string textFilePath3 = @"C:\Users\anshulCsharp\C#Data\testfile3.txt";
        ...
        string textFilePath4 = @"C:\Users\anshulCsharp\C#Data\testfile4.dat";
